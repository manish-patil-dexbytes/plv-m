  ...
  function (q) {
    ...
    var I = {
      ...
      x = function (e) {
        if (e) {
          var t = e;
          return parseInt(q.getComputedStyle(t).height, 10) + e.offsetTop;
        }
        return 0;
      },
      H = function (e, t, n, o) {
    ...
    return function (o, e) {
      ...
      M.animateScroll = function (i, c, e) {
        ...
        if (u || t) {
          var l = q.pageYOffset;
          if (s.header && !O) O = document.querySelector(s.header);
          var n,
            o,
            a,
            m,
            ...
            g = u
              ...
              : (function (e, t, n, o) {
                  var a = 0;
                  if (e.offsetParent) {
                    while ((a += e.offsetTop), (e = e.offsetParent));
                  }
                  a = Math.max(a - t - n, 0);
                  if (o) a = Math.min(a, L() - q.innerHeight);
                  return a;
                })(
                  t,
                  p,
          ...
          if (0 === q.pageYOffset) q.scrollTo(0, 0);
          f = i;
          h = s;
          if (!u) {
            if (history.pushState && h.updateURL) {
              history.pushState(
          ...
          if ("matchMedia" in q && q.matchMedia("(prefers-reduced-motion)").matches) {
